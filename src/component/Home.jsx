  ...
  return (
    <div name='home' className='w-full h-screen bg-[#01192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0] whitespace-nowrap'>
              <Typical loop={Infinity} wrapper='p' steps={['Front End Developer.',2000,' Front End Developer.',2000]}/>
